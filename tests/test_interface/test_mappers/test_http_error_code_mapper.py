...
def test_map_http_error_code_always_returns_http_error_codes() -> None:
    for member in ErrorCode:
        assert map_http_error_code(error_code=member)


def test_map_http_exception_returns_404_or_422_when_receives_domain_exception() -> None:
    ...
    http_exception = map_http_exception(exception=domain_exception)
...
def test_map_http_exception_returns_422_when_receives_validation_error() -> None:
    ...
    http_exception = map_http_exception(exception=validation_error)
...
def test_map_http_exception_returns_500_on_internal_server_error() -> None:
    ...
    http_exception = map_http_exception(exception=internal_server_error)
