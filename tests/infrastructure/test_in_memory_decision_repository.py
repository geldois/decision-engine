...
# tests
def test_in_memory_decision_repository_assigns_correct_ids_when_decision_is_saved_with_rule():
    event = Event(
...
def test_in_memory_decision_repository_assigns_correct_ids_when_decision_is_saved_without_rule():
    event = Event(
        event_type = "USER_CREATED", 
        payload = {
            "user_id": 123,
...
def test_in_memory_decision_repository_assigns_correct_outcome_when_decision_is_saved_with_rule():
    event = Event(
        event_type = "USER_CREATED", 
        payload = {
            "user_id": 123,
...
def test_in_memory_decision_repository_returns_decision_when_id_exists():
    ...
    assert returned_decision is saved_decision
...
def test_in_memory_decision_repository_returns_a_valid_list_of_decisions():
    event = Event(
        event_type = "USER_CREATED", 
        payload = {
            "user_id": 123,
    ...
    assert saved_decision in decisions
